...
public class SparkDriver {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Select only "relevant" hashtags, i.e., the hashtags occurring at
		// least 100 times in the last 30s
		JavaPairDStream<String, Integer> relevantHashtags = hashtagsCounts.filter((Tuple2<String, Integer> element) -> {
